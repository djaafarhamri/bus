      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          <Link to="/add-bus">
            <p
              className={
                location.pathname === "/add-bus" ? selectedCss : notselectedCss
              }
              href="#"
            >
              <svg
          ...
          <Link to="/personne">
            <p
              className={
                location.pathname === "/personne" ? selectedCss : notselectedCss
              }
              href="#"
            >
              <svg
              ...
              <span className="mx-4 font-medium">Personne</span>
            </p>
          </Link>
          <Link to="/colis">
            <p
              className={
                location.pathname === "/colis" ? selectedCss : notselectedCss
              }
              href="#"
            >
              <svg
              ...
              <span className="mx-4 font-medium">Colis</span>
            </p>
          </Link>
        </nav>
{/* 
